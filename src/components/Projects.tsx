...
const projects: ProjectType[] = [
  {
    title: 'Bengal Taxi',
    description: 'Modern cab booking platform for Bengal Taxi, designed to simplify bookings and enhance customer experience.',
        ...
        <div className="space-y-16">
          ...
          >
            <div className="relative z-10 flex flex-col items-center">
              <div className="text-2xl font-bold text-[#86A789] mb-3 font-heading">Project {String(projects.length + 1).padStart(2, '0')}</div>
